...
console.log(file.charAt(1));
//output:
a
b
In practical use, the charAt() method is usually replaced by file[index]. Because it is more convenient:
...
Unicode is a computing indufiley standard for the consistent encoding, representation, and handling of text expressed in most of the world's writing systems.This is the reference information of unicode.

This example will display the character value and unicode value of each characters in file:

var file="abcde";
for (var i=0;i<file.length;i++){
  console.log(file.charAt(i),file.charCodeAt(i));
}
